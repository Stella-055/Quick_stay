...
const roomTypes=[
    "Single Room","Double Room","Luxury Room","Family Suite"
];
const priceranges=[
    "0 to 500","500 to 1000","1000 to 2000","2000 to3000"
];
const sortOptions=[
    "Price low to high","high to low","Newest First"
];
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px=4 md:px-16 lg:px-24'>
        <div>
            ...
            {roomsDummyData.map((room)=>(
                <div  className='flex flex-col md:flex-row items-start py-10 gap-6 border-b  border-gray-300 last:pb-30 last:border-0'>
                    ...
                    alt="" title='View room details ' className='max-h-65 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer' />
       ...
       <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16'>
               <div className= {`flex items-center justify-between px-5 py-5  min-lg:border-b border-gray-300 ${openFilters && "border-b"}`}>
