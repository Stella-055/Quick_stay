...
const AddRoom = () => {
  ...
  return (
   <form action="">
    <Title align="left " font="outfit" title="Add Room" subtitle=" Fill in the form carefully with details that are accurate"/>
    ...
    <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'> 
      ...
      <label htmlFor={`roomImage${key}`}>
        <img src={images[key]?URL.createObjectURL(images[key]):assets.uploadArea} alt=""  className='max-h-13 cursor-pinter opacity-80'/>
