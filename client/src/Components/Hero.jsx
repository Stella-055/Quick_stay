...
transition={Bounce} />
      ...
      <h1 className="font-playfair text-2xl md:text-5xl md:txt-5xl md:text-[56px]md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4">
        Discover The Perfect Gateway Destination
      </h1>
      <p className="max-w=130 mt-2 text-sm md:text-base">
        {" "}
        Unparalleled luxury and comfort await at the worlds most exclusive
        hotels and resort. start your journey with us today and experience the
        difference.
      </p>
