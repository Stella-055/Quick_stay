    ...
    <div className="flex flex-col items-center  px-6 md:px-16 lg:px-24  xl:px-32 pt-20 pb-20">
      <div className="flex flex-col md:flex-row items-center justify-between w-full">
        <Title
          ...
          subtitle="Discover exclusive offers and discounts on your next stay with us. Book now and save big!"
          align="left"
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
        {exclusiveOffers.map((offer, index) => (
          ...
          >
            ...
            <button className="flex items-center gap-2 cursor-pointer mt-4 mb-5">
              View Offers
              <img
                src={assets.arrowIcon}
                alt=""
